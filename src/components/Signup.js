...
export const Signup = (props) => {
     ...
     const handleSubmit = async (e) => {
          ...
          const response = await fetch("http://localhost:5500/api/auth/newuser", {
               ...
               <div className="form-container">
                    <form className="signup-form" onSubmit={handleSubmit}>
                         ...
                         <div className="btn-group">
                              ...
                              <p className='mx-3 my-2 para'>Already Registered?<Link className="text-decoration-none" to="/login" role="button">Login </Link></p>
                         </div>
                    </form>
               </div>
          </div>
